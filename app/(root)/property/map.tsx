...
export default function MapScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-row items-center justify-between p-4 py-3 border border-gray-100 rounded-lg">
        <TouchableOpacity
          onPress={() => router.back()}
        ...
        >
          ...
          <Text className="text-xs text-blue-600 font-semibold">View on Google Maps</Text>
        </TouchableOpacity>
      </View>
